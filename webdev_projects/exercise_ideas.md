...
Some of the ideas are generated by the Gemini AI, others are found through different online communities or are my own ideas i would like to work on in a future. Feel free to add to the list and use the code repository as you wish. Learn by doing and share the knowledge.

### Employee scheduling

- **Description:** Simple scheduling app based on fundamental web technologies, html, css  and javascript.
- **Key Concepts:**
- **Acceptance Criteria:**
  - Input employee names.
  - Input number of work days.
  - Set prefered off days for each employee.
  - Set the required number of employees for each shift.
- **Possible Challenges:**
